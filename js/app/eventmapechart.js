define(function() {
    function createCharts(renderDate) {
        ...
        require(
            ...
            function($, echart) {
            	// changeGridColor(renderDate, id)
             //    editBaseInfo(renderDate, id);
                var poName = renderDate.pollute_name; //污染类型
                var pollutionFir = renderDate.pollution[id];
